...
To get started on NeuroPilot, [install it from the Visual Studio Marketplace <Icon name="vscode" />](https://marketplace.visualstudio.com/items?itemName=Pasu4.neuropilot).
