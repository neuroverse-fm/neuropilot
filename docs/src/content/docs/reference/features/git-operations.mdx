...
This follows the same as normal git merging, selecting another branch to merge to the current branch.
...
This will be sent raw as Neuro understands a diff easier.
...
This action require the Git Config permission to be enabled.
