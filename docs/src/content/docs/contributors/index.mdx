...
- Double check your changes after getting out of the zone for a bit. This can help catch mistakes from tunel vision.
...
- Anything new, changed or removed should be docummented on the docs folder.
