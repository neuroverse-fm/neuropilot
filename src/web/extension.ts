...
import { registerWebUnsupervisedActions, registerWebUnsupervisedHandlers } from '../unsupervised';
...
export function activate(context: vscode.ExtensionContext) {
    ...
    onClientConnected(registerWebUnsupervisedActions);
    onClientConnected(registerWebUnsupervisedHandlers);
...
function reloadPermissions() {
    ...
    registerWebUnsupervisedActions();
}
